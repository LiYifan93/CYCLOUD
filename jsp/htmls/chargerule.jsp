...
<body style="padding-top: 50px;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form-horizontal">
                	<form id="search">
						...
						<div class="form-group">
							<label for="searchType" class="control-label col-md-3">收费类别</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label for="searchCode" class="control-label col-md-3">收费类型编号</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label for="searchName" class="control-label col-md-3">收费类型名称</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label for="searchMonthPrice" class="control-label col-md-3">包月收费金额(分)</label>
							<div class="col-md-8">
								<input type="number" id="searchMonthPrice" name="monthPrice" 
									class="form-control">
							</div>
						</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add" class="form-horizontal" >
						...
						<div class="form-group">
							<label for="type" class="control-label col-md-3">收费类别</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label for="code" class="control-label col-md-3">收费类型编号</label>
							<div class="col-md-8">
								<input type="text" id="code"  name="code"
									class="form-control" placeholder="请输入收费类型编号">
							</div>
						</div>

						<div class="form-group">
							<label for="name" class="control-label col-md-3">收费类型名称</label>
							<div class="col-md-8">
								<input type="text" id="name" name="name" 
									class="form-control" placeholder="请输入收费类型名称">
							</div>
						</div>

						<div class="form-group">
							<label for="monthPrice" class="control-label col-md-3">包月收费金额(分)</label>
							<div class="col-md-8">
								<input type="number" id="monthPrice" name="monthPrice" 
									class="form-control" placeholder="请输入包月收费金额(元)">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<textarea rows="2" cols="45" class="form-control" name="remarks" id="remarks"  placeholder="请填写备注信息"></textarea>
							</div>
						</div>
						
						<div class="form-group">
							<label for="rules" class="control-label col-md-3">收费类型详细规则</label>
							<div class="col-md-8">
								<textarea rows="2" cols="45" class="form-control" name="rules" id="rules" placeholder="请填写收费类型详细规则"></textarea>
							</div>
						</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel" style="text-align: center;">详情</h4>
                </div>
                ...
                <div class="modal-body form-horizontal">
                        <div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" id="editLocalId" 
									name="localId" disabled class="form-control">
							</div>
						</div>

						<div class="form-group">
							<label for="editType" class="control-label col-md-3">收费类别</label>
							<div class="col-md-8">
								<select id="editType" disabled name="type"
									class="form-control">
									<option value="0">临时</option>
									<option value="1">月卡</option>
									<option value="2">免费</option>
						...
						<div class="form-group">
							<label for="editCode" class="control-label col-md-3">收费类型编号</label>
							<div class="col-md-8">
								<input type="text" id="editCode" disabled   name="code"
									class="form-control">
							</div>
						</div>

						<div class="form-group">
							<label for="editName" class="control-label col-md-3">收费类型名称</label>
							<div class="col-md-8">
								<input type="text" id="editName" disabled name="name" 
									class="form-control">
							</div>
						</div>

						<div class="form-group">
							<label for="editMonthPrice" class="control-label col-md-3">包月收费金额(分)</label>
							<div class="col-md-8">
								<input type="number" id="editMonthPrice" disabled name="monthPrice" 
									class="form-control">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<textarea rows="2" cols="45" class="form-control" name="remarks" id="editRemarks" disabled  ></textarea>
							</div>
						</div>
						
						<div class="form-group">
							<label for="editRules" class="control-label col-md-3">收费类型详细规则</label>
							<div class="col-md-8">
								<textarea rows="5" cols="45" class="form-control" name="rules" id="editRules" disabled ></textarea>
							</div>
						</div>
        ...
        <table id="table" data-toggle="table" data-pagination="true" data-page-size="10" data-page-list="[10,20,30,All]" data-pagination-loop="false" data-side-pagination="server" data-response-handler="responseHandler"
            ...
            <thead>
                ...
                <!-- data-sortable="true" data-order="desc" -->
                    ...
                    <th data-field="code" data-align="center" data-valign="middle">收费类型编号</th>
                    <th data-field="name" data-align="center" data-valign="middle">收费类型名称</th>
					<th data-field="type" data-align="center" data-valign="middle">收费类型</th>
                    <th data-field="monthPrice"    data-align="center" data-valign="middle">包月收费金额(分)</th>
                    <th data-field="remarks" data-align="center" data-valign="middle">备注信息</th>
                    <!--formatter: 格式化该列，自定义内容； events: 事件处理函数-->
                    <th id="operate" data-field="details" data-formatter="operateFormatter" data-events="operateEvents" data-align="center" data-valign="middle" data-width="100px">操 作</th>
                </tr>
            </thead>
    ...
    <script>
   		var dataUrl = "${contextPath}/web/chargerule/find?departmentId="
   		var contextPath = "${contextPath}";
   		var addUrl = '${contextPath}/web/chargerule/add'
   		var exportUrl = "${contextPath}/web/chargerule/exportExc"
   			    ...
   			    return {
   			        ...
   			        'localId':$('#searchLocalId').val(),
   			     	'type':$('#searchType').val(),
   			  		'code':$('#searchCode').val(),
   					'name':$('#searchName').val(),
   					'monthPrice':$('#searchMonthPrice').val(),  
					'rules':$('#searchRules').val(), 					
   			    }
   			}
    </script>   
    <script src="${contextPath}/jsp/scripts/url.js"></script>
    <script src="${contextPath}/jsp/scripts/chargerule.js?2"></script>
