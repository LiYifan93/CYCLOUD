...
<body style="padding-top: 50px;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="search">
                        ...
                        <div class="form-group has-feedback">
                            <label for="abnormalTime" class="control-label col-md-3">异常产生时间</label>
                            ...
                            <div class="col-md-6 controls input-append date dateTime s_time" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="startTime" data-link-format="yyyy-mm-dd hh:ii:ss">
                                <input size="16" type="text" value="" readonly id="searchAbnormalTime" name="abnormalTime" required class="form-control" placeholder="请输入开始时间">
                            ...
                            <div class="col-md-2">
                                <select id="searchAbnormalTimeType" name="abnormalTimeType" onchange="change(this.options[this.options.selectedIndex].value)" class="form-control " style="width: 100%;">
							...
							<div class="hid_den" style="display:none"> 
								<div class="col-md-3 controls input-append date dateTime" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="endTime" data-link-format="yyyy-mm-dd hh:ii:ss">
	                                <input size="16" type="text" value="" readonly id="searchAbnormalTime1" name="abnormalTime1" required class="form-control" placeholder="结束时间(可选)">
	                                <span class="add-on"><i class="icon-remove"></i></span>
	                                <span class="add-on"><i class="icon-th"></i></span>
	                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add" class="form-horizontal" >
						<div class="form-group has-feedback" id="d_add">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-md-8 controls input-append date dateTime" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd hh:ii:ss">
                                <input size="16" type="text" value="" readonly name="abnormalTime" required  class="form-control" placeholder="请输入异常产生时间">
                                <span class="add-on"><i class="icon-remove"></i></span>
                                <span class="add-on"><i class="icon-th"></i></span>
                            </div>
                        ...
                        <div class="form-group has-feedback">
                            <label for="abnormalReason" class="control-label col-md-3">事件说明</label>
                            <div class="col-md-8">
                                <input type="text" id="abnormalReason" name="abnormalReason" required class="form-control" placeholder="请输入异常原因">
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="export" class="form-horizontal" >
                   	    ...
                   	    <div class="form-group has-feedback" id="d_export">
                            <label for="departmentId" class="control-label col-md-3">停车场ID</label>
                            <div class="col-md-8">
                                <input type="text" class="departmentId" name="departmentId" class="form-control" required placeholder="请输入停车场ID">
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit" class="form-horizontal">
                        ...
                        <div class="form-group has-feedback">
                            <label for="editAbnormalTime" class="control-label col-md-3">事件开始时间</label>
                            <div class="col-md-8 controls input-append date dateTime" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="dtp_input3" data-link-format="yyyy-mm-dd hh:ii:ss">
                                <input size="16" type="text" value="" id="editAbnormalTime" readonly  name="abnormalTime" required class="form-control" placeholder="请输入异常产生时间">
                                <span class="add-on"><i class="icon-remove"></i></span>
                                <span class="add-on"><i class="icon-th"></i></span>
                            </div>
                        ...
                        <div class="form-group has-feedback">
                            <label for="editAbnormalReason" class="control-label col-md-3">事件说明</label>
                            <div class="col-md-8">
                                <input type="text" id="editAbnormalReason" name="abnormalReason" required class="form-control" placeholder="请输入异常原因">
                            </div>
                        </div>
        ...
        <table id="table" data-toggle="table" data-pagination="true" data-page-size="10" data-page-list="[10,20,30,All]" data-pagination-loop="false" data-side-pagination="server" data-response-handler="responseHandler"
            ...
            <thead>
                ...
                <!-- data-sortable="true" data-order="desc" -->
                    ...
                    <th data-field="abnormalReason" data-align="center" data-valign="middle">异常原因</th>
                    <th data-field="abnormalTime"    data-align="center" data-valign="middle">异常产生时间</th>
    ...
    <script>
   		var dataUrl = "${contextPath}/web/abnormal/searchByCondition?departmentId="
   		var contextPath = "${contextPath}";
   		var addUrl = '${contextPath}/web/abnormal/add'
   		var exportUrl = "${contextPath}/web/abnormal/exportExc"
...
//   	    格式化向服务器发送的参数
   			function paginationParam(params) {
   			    ...
   			    return {
   			        ...
   			        'localId':$('#searchLocalId').val(),
   			     	'uin':$('#searchUin').val(),
   			  		'abnormalTime':$('#searchAbnormalTime').val(),
   					'abnormalTimeType':$('#searchAbnormalTimeType').val(),
   					'abnormalTime1':$('#searchAbnormalTime1').val(),   					
   			    }
   			}
    ...
    <script src="${contextPath}/jsp/scripts/abnormal.js?2"></script>
