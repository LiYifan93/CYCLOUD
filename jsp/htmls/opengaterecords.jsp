...
<body style="padding-top: 50px;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="searchPassId" class="control-label col-md-3">通道ID</label>
                            <div class="col-md-8">
                                <input type="text" id="searchPassId" name="passId" class="form-control" placeholder="请输入通道ID">
                            </div>
                        </div>

                        <div class="form-group">

                            <label for="date" class="control-label col-md-3">开闸时间段</label>
                            ...
                            <div class="col-md-6 controls input-append date dateTime s_time" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="startTime" data-link-format="yyyy-mm-dd hh:ii:ss">
                                <input size="16" type="text" value="" readonly id="searchDate" name="date" required class="form-control" placeholder="请输入开闸开始时间">
                            ...
                            <div class="col-md-2">
                                <select id="searchDateType" name="dateType" onchange="change(this.options[this.options.selectedIndex].value)" class="form-control " style="width: 100%;">
                            ...
                            <div class="hid_den" style="display:none">
	                            <div class="col-md-3 controls input-append date dateTime" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="endTime" data-link-format="yyyy-mm-dd hh:ii:ss">
	                                <input size="16" type="text" value="" readonly id="searchDate1" name="date1" required class="form-control" placeholder="开闸结束时间(可选)">
	                                <span class="add-on"><i class="icon-remove"></i></span>
	                                <span class="add-on"><i class="icon-th"></i></span>
	                            </div>
    ...
    <div id="modal-add" class="modal fade" aria-hidden="true" aria-labelledby="myModalLabel">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
...
<!--                    <div class="form-group">
                            <label for="img" class="control-label col-md-3">图片地址</label>
                            <div class="col-md-8">
                                <input type="file" id="img" name="pic" required accept=".jpg,.png">
                            </div>
                        </div>
 -->
                        <div class="form-group">
                            <label for="date" class="control-label col-md-3">开闸时间</label>
                            <div class="col-md-8 controls input-append date dateTime " data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd hh:ii:ss">
                                <input size="16" type="text" value="" readonly name="date" required class="form-control" placeholder="请输入开闸时间">
                                <span class="add-on"><i class="icon-remove"></i></span>
                                <span class="add-on"><i class="icon-th"></i></span>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="passId" class="control-label col-md-3">通道ID</label>
                            <div class="col-md-8">
                                <input type="text" id="passId" name="passId" required class="form-control" placeholder="请输入通道ID">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="reason" name="reason" required class="form-control" placeholder="请输入原因">
                            </div>
                        </div>

                      <!--   <div class="form-group">
                            <label for="shiftSign" class="control-label col-md-3">交班标记</label>
                            <div class="col-md-8">
                                <input type="text" id="shiftSign" name="shiftSign" required class="form-control" placeholder="请输入交班标记">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="shiftTime" class="control-label col-md-3">交接时间</label>
                            <div class="col-md-8 controls input-append date dateTime" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="dtp_input3" data-link-format="yyyy-mm-dd hh:ii:ss">
                                <input size="16" type="text" value="" readonly id="shiftTime" name="shiftTime" required class="form-control" placeholder="请输入交接时间">
                                <span class="add-on"><i class="icon-remove"></i></span>
                                <span class="add-on"><i class="icon-th"></i></span>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="editDate" class="control-label col-md-3">开闸时间</label>
                            <div class="col-md-8 controls input-append date dateTime" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="dtp_input3" data-link-format="yyyy-mm-dd hh:ii:ss">
                                <input size="16" type="text" value="" readonly  id="editDate" name="date" required class="form-control" placeholder="请输入开闸时间">
                                <span class="add-on"><i class="icon-remove"></i></span>
                                <span class="add-on"><i class="icon-th"></i></span>
                            </div>
                            <input type="hidden" id="dtp_input3" value="" />
                        ...
                        <div class="form-group">
                            <label for="editPassId" class="control-label col-md-3">通道ID</label>
                            <div class="col-md-8">
                                <input type="text" id="editPassId" name="passId" required class="form-control" placeholder="请输入通道ID">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="editReason" name="reason" required class="form-control" placeholder="请输入原因">
                            </div>
                        </div>

                        <!-- <div class="form-group">
                            <label for="editShiftSign" class="control-label col-md-3">交接标记</label>
                            <div class="col-md-8">
                                <input type="text" id="editShiftSign" name="shiftSign" required class="form-control" placeholder="请输入交接标记">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="editShiftTime" class="control-label col-md-3">交接时间</label>
                            <div class="col-md-8 controls input-append date dateTime" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="dtp_input3" data-link-format="yyyy-mm-dd hh:ii:ss">
                                <input size="16" type="text" value="" readonly  id="editShiftTime" name="shiftTime" required class="form-control" placeholder="请输入交接时间">
                                <span class="add-on"><i class="icon-remove"></i></span>
                                <span class="add-on"><i class="icon-th"></i></span>
                            </div>
                            <input type="hidden" id="dtp_input3" value="" />
    ...
    <div class="container " style="margin-top: 50px">
        ...
        <table id="table"  data-toggle="table" data-pagination="true" data-page-size="10" data-page-list="[10,20,30,All]" data-pagination-loop="false" data-side-pagination="server" data-response-handler="responseHandler"
            data-query-params="paginationParam" data-cache="false" data-toolbar="#toolbar" data-show-toggle="true" data-method="post" data-show-refresh="true" data-page-number="1" data-content-type="application/x-www-form-urlencoded; charset=UTF-8">
            <thead>
                <tr>
                    ...
                    <th data-field="imgPath" data-Formatter="imgPathFormatter" data-align="center" data-valign="middle">图片地址</th> 
                    <th data-field="date" data-align="center" data-valign="middle">开闸时间</th>
                    <th data-field="passId" data-align="center" data-valign="middle">通道ID</th>
                    <th data-field="reason" data-align="center" data-valign="middle">原因</th>
                    <!-- <th data-field="shiftSign" data-align="center" data-valign="middle">交班标记</th>
                    <th data-field="shiftTime" data-align="center" data-valign="middle">交班时间</th> -->
    ...
    <script src="${contextPath}/jsp/libs/bootstrap-datetimepicker/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
     <script src="${contextPath}/jsp/libs/modal.js" charset="UTF-8"></script>
     <script>
   		var dataUrl = "${contextPath}/web/opengaterecords/searchByCondition?departmentId="
   		var contextPath = "${contextPath}";
   		var addUrl = '${contextPath}/web/opengaterecords/add'
   		var exportUrl = "${contextPath}/web/opengaterecords/exportExc"
    ...
    <script src="${contextPath}/jsp/scripts/url.js?2"></script>
    <script src="${contextPath}/jsp/scripts/opengaterecords.js?1"></script>
